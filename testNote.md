...
- [x] How does will the token change work with the developer? Research how token works with other auth tools.

- for google, github, and other oauth authentication, users should not have to input their clientID and secret into the app, they should have in their .env.

## TODO
- [x] Research how tokens (both access tokens and refresh token work) in other auth tools.
